...
import logo from "../../images/bg-img.png"
  ...
  return (
    <div className="flex h-screen p-16">
      <div className="container mx-auto flex">
        ...
        <div className="w-1/2 h-full">
          ...
          <div className="py-24">
            ...
            <p className="font-sans mb-0 w-80">
              Готовим и быстро привозим поке, супы, роллы и пиццу в которых
              правда много свежих море продуктов (и не только).
            </p>
        ...
        {/* Right */}
        <div className="w-1/2 h-full">
          <img src={logo} alt="Поке" className="max-h-full" />
        </div>
      </div>
    </div>
  )
