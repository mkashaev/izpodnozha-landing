          ...
          >
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                ...
                <div className="mt-3 text-center sm:mt-5">
                  ...
                  <div className="mt-2">
                    <p className="font-sans text-sm text-gray-500">
                      Оставьте контакты, мы пришлем вам купон со скидкой 50%,
                      когда начнем принимать заказы.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                <label
                  htmlFor="phone"
                  className="font-sans block text-sm font-medium text-gray-700"
                >
                  Номер телефона
                </label>
                <div className="mt-1">
                  <input
                    ...
                    name="phone"
                    id="phone"
                    className="font-sans shadow-sm focus:ring-yellow-500 focus:border-yellow-500 block w-full sm:text-sm border-gray-300 rounded-md"
